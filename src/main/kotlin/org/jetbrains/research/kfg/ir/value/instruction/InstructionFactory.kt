...
class InstructionFactory private constructor() {
    ...
    fun getCall(opcode: CallOpcode, name: ValueName, method: Method, `class`: Class, args: Array<Value>): Instruction = CallInst(opcode, name, method, `class`, args)
    fun getCall(opcode: CallOpcode, name: ValueName, method: Method, `class`: Class, obj: Value, args: Array<Value>): Instruction = CallInst(opcode, name, method, `class`, obj, args)
